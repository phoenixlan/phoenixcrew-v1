...
import { DashboardContent, DashboardHeader, DashboardSubtitle, DashboardTitle, InnerContainer, InnerContainerRow, PanelButton, SpanLink } from '../../components/dashboard';
...
export const PositionList = () => {
    ...
    const { data, isLoading } = useQuery(['positionsDetailed'], async () => {
        ...
        return { positions, crews, currentEvent };
    });
    ...
    const { positions: roles, crews, currentEvent } = data;
